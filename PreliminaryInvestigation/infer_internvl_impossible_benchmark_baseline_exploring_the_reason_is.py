...
if __name__ == '__main__':
    ...
    output_path = '../res/res_on_impossible_videos_InternVL_IS.json'


    prompt = 'Given the video content, which is generated by artificial intelligence, evaluate whether the depicted motion of objects or individuals adheres to the real world. Start your answer wtih \'Yes.\' or \'No.\' and give the explanation.'
